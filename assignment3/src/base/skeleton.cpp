...
void Skeleton::setJointRotation(unsigned index, Vec3f euler_angles) {
	...
	Mat3f eulerMatrice = Mat3f::rotation(Vec3f(1.0, 0, 0), euler_angles[2])
		* Mat3f::rotation(Vec3f(0, 1.0, 0), euler_angles[1])
		* Mat3f::rotation(Vec3f(0, 0, 1.0), euler_angles[0]);

	joint.to_parent.setCol(0, Vec4f(eulerMatrice.getCol(0), 0));
	joint.to_parent.setCol(1, Vec4f(eulerMatrice.getCol(1), 0));
	joint.to_parent.setCol(2, Vec4f(eulerMatrice.getCol(2), 0));
}
